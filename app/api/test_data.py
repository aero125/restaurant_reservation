    ...
    def fill_databese(self, count: int) -> dict:
        ...
        try:
            with conn.cursor() as cursor:
                cursor.execute("SELECT table_number from tables ORDER BY id DESC LIMIT 1")
                row = cursor.fetchone()
                ...
                for _ in range(count):
                    ...
                    cursor.execute("INSERT INTO users (name, age, email, phone, promocode_id, balance) VALUES (%s, %s, %s, %s, %s, %s) ON CONFLICT (email) DO NOTHING RETURNING id", 
                    ...
                    cursor.execute('INSERT INTO promocodes (code, created_at, expires_at, discount) VALUES (%s, %s, %s, %s) ON CONFLICT (code) DO NOTHING RETURNING id',
                    ...
                    seats = randint(4, 6)
                    cursor.execute('INSERT INTO tables (table_number, price, seats) VALUES (%s, %s, %s) ON CONFLICT (table_number) DO NOTHING RETURNING id',
